...
/*
 ライフゲーム
 John Horton Conwayが提案した「ライフゲーム」セル・オートマトンを実装したプロ
 グラムを書きなさい。このゲームの盤面は、正方形のセルのグリッドで、セルは死ん
 でいるか生きているかという2つの状態があります。どのセルも隣接するセルの状態に
 よって1ステップごと次のような規則で状態が遷移します。
 ● 生きているセルは、生きている隣接セルが1つ以下だと死ぬ。人口過疎で死に絶
 えるようなもの。
 ● 生きているセルは、隣接セルが2つか3つ生きているなら次の世代でも生きてい
 る。
 ● 生きているセルは、隣接セルが4つ以上生きていると死ぬ。人口過剰。
 ● 死んでいるセルは、隣接セルがちょうど3つ生きているなら生き返る。再生。
 イテレーションごとにゲームの状態をコンソールに出力します。便宜上、例えば、20
 行×50列のような適当なサイズを選びます。
 */
class universe
{
private:
